...
export function PieChartVariant1({ stats }: ImpactScoreDisplayProps) {
  ...
  const chartData = [
    { name: "Commits", value: data.breakdown.commits, raw: stats.totalCommits, fill: COLORS[0] },
    { name: "PRs", value: data.breakdown.prs, raw: stats.totalPRs, fill: COLORS[1] },
    { name: "Merged PRs", value: data.breakdown.mergedPrs, raw: stats.totalMergedPRs, fill: COLORS[4] },
    { name: "Issues", value: data.breakdown.issues, raw: stats.totalIssuesClosed, fill: COLORS[2] },
    { name: "Reviews", value: data.breakdown.reviews, raw: stats.totalReviews, fill: COLORS[3] },
  ];
